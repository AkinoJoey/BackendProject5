<div class="col-12">
    <form action="#" method="post" id="update-part-form" class="d-flex row">
        ...
        <input type="number" step="any" name="marketPrice" value="<?= $part ? $part->getMarketPrice() : '' ?>" placeholder="Market Price" required><br>
        <input type="number" step="any" name="rsm" value="<?= $part ? $part->getRsm() : '' ?>" placeholder="RSM" required><br>
        ...
        <input type="number" step="any" name="lifespan" value="<?= $part ? $part->getLifespan() : '' ?>" placeholder="Lifespan (years)" required><br>
